...
// All of these imports are what makes the Dashboard interactive
// i.e Drawer is touch-enabled slide-in drawer
...
const useStyles = makeStyles((theme: Theme) => createStyles({
    ...
    column: {
     ...
     appBar: {
        // transitions are theme key to customize the duration and easings of various transitions
...
export const Dashboard = withRouter((props:DashboardProps) => {
    ...
    // Navbar link options on the left side
    const itemsList = [
        {
            text: 'Home',
    ...
    return (
        <div className={`${classes.root} ${classes.column}`}>
            <CssBaseline /> {/* Think of it as default styling (standard style) like Normalize.css */}
            ...
            {/* this is where the table style layout is coming into play containing car data */}
            </MUIDrawer>
