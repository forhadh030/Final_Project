      ...
      <div className="container">
        <div className="top">
          ...
          <div className="temp">
            ...
            {data.main ? <h1 id="temp">{data.main.temp.toFixed()}°F</h1> : null}
          </div>
          <div className="description">
            {data.weather ? <p class="p">{data.weather[0].main}</p> : null}
          </div>
        </div>
        ...
        {data.name !== undefined &&
          <div className="bottom">
            <div className="feels">
            <p>Feels Like</p>
              {data.main ? <p class="p" className='bold'>{data.main.feels_like.toFixed()}°F</p> : null}
            </div>
            <div className="humidity">
            <p>Humidity</p>
              {data.main ? <p class="p" className='bold'>{data.main.humidity}%</p> : null}
            </div>
            <div className="wind">
            <p>Wind Speed</p>
              {data.wind ? <p class="p" className='bold'>{data.wind.speed.toFixed()} MPH</p> : null}
            </div>
          </div>
        }
      </div>
